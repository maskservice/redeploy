...
- **generated_from**: pyproject.toml, Makefile, app.doql.less, goal.yaml, .env.example, src(14 mod), project/(2 analysis files)
...
# redeploy | 144f 32760L | python:141,shell:2,less:1 | 2026-04-21
# stats: 489 func | 307 cls | 144 mod | CC̄=5.6 | critical:80 | cycles:0
# alerts[5]: CC hardware=47; CC _analyze=44; CC _render=38; CC build_context=36; CC extract_blueprint=31
# hotspots[5]: hardware fan=27; device_map_cmd fan=26; version_init fan=26; audit fan=22; import_cmd fan=22
# evolution: baseline
...
M[144]:
  ...
  redeploy/apply/__init__.py,50
  redeploy/apply/exceptions.py,13
  redeploy/apply/executor.py,262
  redeploy/apply/handlers.py,427
  ...
  redeploy/blueprint/extractor.py,329
  ...
  redeploy/version/sources/base.py,45
  redeploy/version/sources/json_.py,95
  redeploy/version/sources/plain.py,29
  redeploy/version/sources/regex.py,70
  redeploy/version/sources/toml_.py,109
  redeploy/version/sources/yaml_.py,99
  redeploy/version/transaction.py,163
  redeploy/version.py,97
...
D:
  ...
  redeploy/apply/handlers.py:
    e: run_ssh,run_scp,run_rsync,run_docker_build,run_podman_build,run_docker_health_wait,_parse_container_statuses,_all_containers_healthy,run_container_log_tail,run_http_check,run_version_check,run_plugin,run_wait,run_inline_script,_resolve_command_ref
    run_ssh(step;probe)
  ...
  redeploy/blueprint/extractor.py:
    e: extract_blueprint,_merge_compose,_parse_compose_ports,_parse_compose_volumes,_parse_compose_env,_parse_compose_healthcheck,_parse_migration_meta,_build_hw_requirements
    extract_blueprint()
    ...
    _parse_migration_meta(path)
    _build_hw_requirements(hw)
  ...
  redeploy/cli/commands/blueprint.py:
    e: blueprint_cmd,capture,twin,deploy,show,list_blueprints,_print_blueprint
    blueprint_cmd()
  ...
  redeploy/cli/commands/device_map.py:
    e: device_map_cmd,_render,_print_list,_diff
    device_map_cmd(host;name;tags;save;out_path;output_fmt;no_infra;list_saved;show_file;diff_files;ssh_key)
  ...
  redeploy/cli/commands/diff.py:
    e: diff
    diff(ci_file;host;from_src;to_src;out_format)
  ...
  redeploy/cli/commands/export.py:
    ...
    export_cmd(ctx;fmt;output;src_file)
  ...
  redeploy/cli/commands/hardware.py:
    e: hardware
    hardware(host;output_fmt;show_fix;apply_fix_component;ssh_key)
  ...
  redeploy/cli/commands/plan_apply.py:
    e: plan,apply,migrate,run,_apply_manifest_to_spec,_print_spec_summary,_perform_live_detect,_run_apply
    ...
    run(ctx;spec_file;dry_run;plan_only;do_detect;plan_out;output;env_name;progress_yaml;resume;from_step;state_file;no_state)
  ...
  redeploy/cli/commands/version.py:
    e: version_cmd,version_current,version_list,version_verify,version_bump,version_set,version_init,version_diff,_resolve_monorepo_targets,_build_package_version_manifest,_resolve_package_release_git_config,_resolve_package_release_changelog_config,_print_verify_result,_print_source_drift_status,_load_spec_version_diff,_load_live_version_diff,_run_version_diff_for_manifest,_bump_single,_format_release_tag,_update_release_changelog,_set_monorepo_version,_print_monorepo_set_dry_run,_create_version_set_git,_create_version_set_taggers,_create_release_tags,_finalize_monorepo_version_set,_update_monorepo_release_changelogs,_version_scan_specs,_regex_version_scan_specs,_is_scannable_version_path,_normalize_scan_exclusions,_detect_version_sources_in_dir,_detect_source_version,_read_detected_source_versions,_report_version_scan_conflict,_print_version_scan_review,_classify_version_scan_source_confidence,_format_version_scan_source_status,_default_keep_scanned_source,_summarize_version_scan_group,_print_version_scan_group,_iter_version_scan_groups,_review_detected_sources_interactively,_derive_scanned_package_name,_scan_package_version_manifests
    version_cmd()
  ...
  redeploy/cli/display.py:
    e: print_plan_table,print_infrastructure_summary,print_docker_services,print_k3s_pods,print_conflicts,print_inspect_app_metadata,print_inspect_environments,print_inspect_templates,print_inspect_workflows,print_inspect_devices,print_inspect_raw_nodes_summary,print_workflow_summary_table,print_workflow_host_details,generate_workflow_output_css,generate_workflow_output_yaml,print_import_spec
  ...
  redeploy/detect/hardware.py:
    e: _lines,probe_board,probe_config_txt,probe_drm_outputs,probe_wlr_randr,probe_backlights,probe_framebuffers,probe_i2c_buses,probe_dsi_dmesg,_analyze,probe_hardware
    _lines(text)
    probe_board(p)
    probe_config_txt(p)
    probe_drm_outputs(p)
  ...
  redeploy/detect/templates.py:
    e: build_context,_svc,_port,_build_templates,Condition,DetectionTemplate,TemplateMatch,DetectionResult,TemplateEngine
  ...
  redeploy/iac/docker_compose.py:
    ...
    DockerComposeParser: can_parse(1),parse(1),_load_merged(2),_find_override(1),_load_dotenv(1),_parse_service(4)  # Parser for docker-compose.yml / compose.yaml files.
  ...
  redeploy/iac/parsers/compose.py:
    ...
    DockerComposeParser: can_parse(1),parse(1),_parse_service(3),_parse_build(1),_parse_command(1),_parse_ports(2),_parse_port_entry(1),_parse_volumes(2),_parse_volume_entry(1),_parse_env(2),_parse_depends_on(1),_parse_labels(1),_parse_healthcheck(1)  # Parser for Docker Compose files (v2 + v3 schema, Compose Spe
  redeploy/iac/registry.py:
    e: parse_file,parse_dir
    parse_file(path)
  ...
  redeploy/markpact/parser.py:
    e: parse_markpact_file,parse_markpact_text,_parse_markpact_fence_info,parse_markpact_file_with_refs,extract_script_by_ref,extract_script_from_markdown,_normalize_section_id,_check_heading,_handle_fence_line,MarkpactParseError
  ...
  redeploy/models.py:
    e: ConflictSeverity,StepAction,StepStatus,DeployStrategy,ServiceInfo,PortInfo,ConflictInfo,RuntimeInfo,AppHealthInfo,DrmOutput,BacklightInfo,I2CBusInfo,HardwareDiagnostic,HardwareInfo,InfraState,TargetConfig,MigrationStep,InfraSpec,MigrationSpec,MigrationPlan,EnvironmentConfig,ProjectManifest,DeployRecord,KnownDevice,DeviceMap,ServicePort,VolumeMount,ServiceSpec,HardwareRequirements,BlueprintSource,DeviceBlueprint,DeviceRegistry
    ConflictSeverity:
    StepAction:
    StepStatus:
    DeployStrategy:
    ...
    HardwareInfo: has_dsi(0),dsi_connected(0),dsi_enabled(0),backlight_on(0),errors(0),warnings(0)  # Hardware state produced by hardware probe.
    ...
    EnvironmentConfig:  # One named environment (prod / dev / rpi5 / staging …) in red
    ...
    DeviceMap: has_errors(0),display_summary(0),to_yaml(0),save(1),load(2),load_for(2),list_saved(1)  # Full, persisted snapshot of a device: identity + InfraState 
    ...
    DeviceBlueprint: service(1),to_yaml(0),save(1),load(2),list_saved(1)  # Self-contained, portable deployment recipe.
  ...
  redeploy/version/sources/base.py:
    e: BaseAdapter
    BaseAdapter: _validate_path(2),_extract_version(2),_create_temp(1),_atomic_write(3)  # Base class for source adapters with common utilities.
  redeploy/version/sources/json_.py:
    e: JsonAdapter
    JsonAdapter: read(2),write(3),stage(3),_detect_indent(1)  # Read/write version from JSON files.
  redeploy/version/sources/plain.py:
    e: PlainAdapter
    PlainAdapter: read(2),write(3),stage(3)  # Read/write version from plain text file.
  redeploy/version/sources/regex.py:
    e: RegexAdapter
    RegexAdapter: read(2),write(3),stage(3)  # Read/write version using regex pattern with capture group.
  redeploy/version/sources/toml_.py:
    e: TomlAdapter
    TomlAdapter: _get_toml_lib(0),read(2),write(3),stage(3)  # Read/write version from TOML files using tomllib/tomli.
  redeploy/version/sources/yaml_.py:
    e: YamlAdapter
    YamlAdapter: _get_yaml_lib(0),read(2),write(3),stage(3)  # Read/write version from YAML files.
