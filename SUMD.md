...
# redeploy | 164f 33844L | python:161,shell:2,less:1 | 2026-04-21
# stats: 567 func | 311 cls | 164 mod | CC̄=5.1 | critical:77 | cycles:0
# alerts[5]: CC _render=38; CC build_context=36; CC extract_blueprint=31; CC probe=26; CC version_init=26
# hotspots[5]: device_map_cmd fan=26; version_init fan=26; audit fan=22; hardware fan=22; import_cmd fan=22
# evolution: baseline
...
M[164]:
  ...
  redeploy/apply/executor.py,265
  redeploy/apply/handlers.py,401
  ...
  redeploy/cli/commands/hardware.py,315
  ...
  redeploy/detect/hardware.py,284
  redeploy/detect/hardware_rules.py,263
  redeploy/detect/probes.py,278
  redeploy/detect/remote.py,5
  redeploy/detect/templates.py,375
...
D:
  ...
  redeploy/apply/handlers.py:
    e: run_ssh,run_scp,run_rsync,run_docker_build,run_podman_build,run_docker_health_wait,_parse_container_statuses,_all_containers_healthy,run_container_log_tail,run_http_check,run_version_check,run_plugin,run_wait,run_inline_script,_resolve_command_ref,run_ensure_config_line,run_raspi_config
    run_ssh(step;probe)
  ...
  redeploy/cli/commands/hardware.py:
    e: _probe_hardware,_format_output,_print_drm_connectors,_print_backlights,_print_dsi_overlays,_print_i2c_buses,_print_diagnostics,_apply_fix,hardware
    ...
    hardware(host;output_fmt;show_fix;apply_fix_component;panel_id;list_panels;ssh_key)
  ...
  redeploy/detect/hardware_rules.py:
    e: _dsi_outputs,_has_dsi_overlay,_dsi_connected,_backlight_chip_addr,_backlight_power_off_rules,_i2c_chip_missing_rules,_all_ok,_any_errors_from_static,analyze,DiagnosticRule
    DiagnosticRule: evaluate(1)  # A single hardware diagnostic rule.
    _dsi_outputs(hw)
    _has_dsi_overlay(hw)
    _dsi_connected(hw)
  ...
  redeploy/detect/templates.py:
    e: build_context,_svc,_port,_load_templates_from_yaml,_build_templates,Condition,DetectionTemplate,TemplateMatch,DetectionResult,TemplateEngine
  ...
  redeploy/models.py:
    ...
    HardwareInfo: has_dsi(0),kms_enabled(0),dsi_connected(0),dsi_enabled(0),backlight_on(0),errors(0),warnings(0)  # Hardware state produced by hardware probe.
