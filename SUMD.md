...
# redeploy | 172f 35704L | python:169,shell:2,less:1 | 2026-04-21
# stats: 620 func | 319 cls | 172 mod | CC̄=5.1 | critical:83 | cycles:0
# alerts[5]: CC _render=38; CC build_context=36; CC extract_blueprint=31; CC probe=26; CC version_init=26
# hotspots[5]: hardware fan=28; device_map_cmd fan=26; version_init fan=26; audit fan=22; import_cmd fan=22
# evolution: baseline
...
M[172]:
  ...
  redeploy/apply/handlers.py,535
  ...
  redeploy/cli/__init__.py,116
  redeploy/cli/commands/__init__.py,45
  redeploy/cli/commands/audit.py,127
  redeploy/cli/commands/blueprint.py,412
  redeploy/cli/commands/detect.py,119
  redeploy/cli/commands/device_map.py,526
  ...
  redeploy/cli/commands/hardware.py,600
  ...
  redeploy/detect/hardware.py,354
  redeploy/detect/hardware_rules.py,490
...
D:
  ...
  redeploy/cli/commands/blueprint.py:
    e: blueprint_cmd,capture,_apply_blueprint_config,_execute_query_blueprint,twin,deploy,show,list_blueprints,_print_blueprint
    blueprint_cmd()
    capture(host;name;compose_files;migration_file;device_map_file;live;save;out_path;fmt;tags)
    _apply_blueprint_config(bp;config_path)
  ...
  redeploy/cli/commands/device_map.py:
    e: device_map_cmd,_apply_config_from_file,_update_kanshi_from_cfg,_render,_print_list,_diff
    device_map_cmd(host;name;tags;save;out_path;output_fmt;no_infra;list_saved;show_file;diff_files;ssh_key;apply_config)
    _apply_config_from_file(console;config_path;ssh_key)
  ...
  redeploy/cli/commands/hardware.py:
    e: _probe_hardware,_format_output,_print_drm_connectors,_print_backlights,_print_dsi_overlays,_print_i2c_buses,_print_diagnostics,_apply_transform,_apply_config,_update_kanshi_from_cfg,_execute_query,_apply_fix,hardware
    ...
    _apply_config(console;p;config_path)
    _update_kanshi_from_cfg(console;p;dsi_outputs)
  ...
  redeploy/detect/hardware.py:
    e: _lines,probe_board,probe_config_txt,probe_drm_outputs,probe_wlr_randr,probe_backlights,probe_framebuffers,probe_i2c_buses,probe_dsi_dmesg,probe_dsi_dmesg_errors,probe_kernel_modules,probe_wayland_sockets,probe_compositor_processes,_analyze,probe_hardware
    _lines(text)
    probe_board(p)
    probe_config_txt(p)
    probe_drm_outputs(p)
    ...
    probe_i2c_buses(p)
    probe_dsi_dmesg(p)
    probe_dsi_dmesg_errors(dmesg_lines)
    probe_kernel_modules(p)
    probe_wayland_sockets(p)
    probe_compositor_processes(p)
    _analyze(hw)
    probe_hardware(p)
