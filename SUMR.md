...
- **generated_from**: pyproject.toml, Makefile, app.doql.less, pyqual.yaml, goal.yaml, .env.example, src(14 mod), project/(6 analysis files)
...
# redup/duplication | 4 groups | 131f 22939L | 2026-04-21
