...
# code2llm | 323f 57451L | python:158,yaml:106,md:52,shell:2,yml:1,txt:1,toml:1,json:1 | 2026-04-21
# CC̄=1.7 | critical:40/2607 | dups:0 | cycles:0

HEALTH[20]:
  🔴 GOD   redeploy/models.py = 1096L, 34 classes, 30m, max CC=19
  🔴 GOD   redeploy/audit.py = 609L, 6 classes, 32m, max CC=14
  🔴 GOD   SUMR.md = 2788L, 51 classes, 140m, max CC=0.0
  🔴 GOD   SUMD.md = 2782L, 51 classes, 826m, max CC=0.0
...
LAYERS:
  ...
  │
  redeploy/                       CC̄=5.0    ←in:89  →out:14  !! split
  ...
  │
  ./                              CC̄=0.0    ←in:0  →out:0
  │ !! SUMR.md                   2788L  51C  140m  CC=0.0    ←0
  │ !! SUMD.md                   2782L  51C  826m  CC=0.0    ←3
  ...
  │ !! README.md                 2525L  0C    1m  CC=0.0    ←0
  ...
  │ !! calls.yaml                6184L  0C    0m  CC=0.0    ←0
  │ !! map.toon.yaml             1717L  0C  720m  CC=0.0    ←0
  │ !! context.md                 723L  0C    0m  CC=0.0    ←0
  │ !! validation.toon.yaml       683L  0C    0m  CC=0.0    ←0
  │ !! calls.toon.yaml            523L  0C    0m  CC=0.0    ←0
...
COUPLING:
                              redeploy.cli             redeploy  redeploy.dsl_python     DOQL-INTEGRATION     redeploy.version       redeploy.apply                 SUMD        redeploy.heal    redeploy.markpact         redeploy.iac        redeploy.plan      redeploy.detect         redeploy.dsl   redeploy.blueprint    redeploy.hardware
         redeploy.cli                   ──                   52                   ←1                    4                   21                   10                                                              3                    2                    5                    2                    7                    3                    2  !! fan-out
             redeploy                  ←52                   ──                   ←3                                        ←1                   ←2                    8                   ←1                    2                   ←7                    1                   ←6                    1                   ←2                   ←1  hub
  redeploy.dsl_python                    1                    3                   ──                   21                    1                                                                                                                                                                                                                    !! fan-out
     DOQL-INTEGRATION                   ←4                                       ←21                   ──                                                                                                                                                                                                                                         hub
     redeploy.version                  ←21                    1                   ←1                                        ──                                                                                                                                                                                                                    hub
       redeploy.apply                  ←10                    2                                                                                  ──                    2                                         2                                                                                                                             3  hub
                 SUMD                                        ←8                                                                                  ←2                   ──                   ←8                                                                                                                                                     hub
        redeploy.heal                                         1                                                                                                        8                   ──                                                              1                                                                                      !! fan-out
  ...
  SMELL: redeploy/ fan-out=14 → split needed
...
# redup/duplication | 11 groups | 157f 26350L | 2026-04-21
...
# code2llm/evolution | 2582 func | 139f | 2026-04-21
